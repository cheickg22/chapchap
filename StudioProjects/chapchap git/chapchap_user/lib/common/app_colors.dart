...
class AppColors {
  static const Color primary = Color(0xFFFCA53D); //Color(0xFF0F632D)
...
// Common colors
  ...
  // MoovMoney brand colors
  static const Color moovColor = Color(0xFF0066CC); // Bleu MoovMoney
  static const Color moovOrange = Color(0xFFFF6600); // Orange MoovMoney
}
