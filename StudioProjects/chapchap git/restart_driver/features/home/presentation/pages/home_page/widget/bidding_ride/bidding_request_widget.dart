                    ...
                    children: [
                      CustomButton(
                        ...
                        onTap: () {
                          ...
                          final enteredFare = double.parse(
                            context.read<HomeBloc>().bidRideAmount.text.trim(),
                          );

                          final minFare =
                              roundToTwoDecimals(homeBloc.minFare ?? 0.0);
                          final maxFare = roundToTwoDecimals(
                              homeBloc.maxFare ?? double.infinity);
                          final fare = roundToTwoDecimals(enteredFare);
                          if ((!context
                                      .read<HomeBloc>()
                                      .isBiddingIncreaseLimitReach &&
                                  !context
