...
class RideApi {
  ...
  Future getGeocodingAddress(
    ...
    try {
      // Set headers based on map provider
      ...
      if (mapType == 'google_map') {
        ...
        // Per Nominatim usage policy, set a descriptive User-Agent and optional Referer
        final pkg = await PackageInfo.fromPlatform();
        final userAgent =
            '${AppConstants.title}/${pkg.version} (${AppConstants.baseUrl})';
        headers = {
