...
import 'package:restart_user/features/home/data/repository/ride_api.dart';
import 'package:restart_user/features/home/domain/models/add_review_model.dart';
...
import 'package:restart_user/features/home/domain/models/cancel_request_model.dart';
import 'package:restart_user/features/home/domain/models/chat_seen_model.dart';
import 'package:restart_user/features/home/domain/models/eta_details_model.dart';
import 'package:restart_user/features/home/domain/models/geocoding_address_model.dart';
import 'package:restart_user/features/home/domain/models/geocoding_lat_lng_model.dart';
import 'package:restart_user/features/home/domain/models/payment_recieved_model.dart';
import 'package:restart_user/features/home/domain/models/polyline_model.dart';
import 'package:restart_user/features/home/domain/models/respond_request_model.dart';
import 'package:restart_user/features/home/domain/models/ride_arrived_model.dart';
import 'package:restart_user/features/home/domain/models/ride_chat_model.dart';
import 'package:restart_user/features/home/domain/models/ride_end_model.dart';
import 'package:restart_user/features/home/domain/models/ride_start_model.dart';
import 'package:restart_user/features/home/domain/models/send_chat_model.dart';
import 'package:restart_user/features/home/domain/models/instant_ride_model.dart';
import 'package:restart_user/features/home/domain/models/goods_type_model.dart';
import 'package:restart_user/features/home/domain/models/stop_complete_model.dart';
import 'package:restart_user/features/home/domain/models/upload_proof_model.dart';
import 'package:restart_user/features/home/domain/repositories/ride_repo.dart';
      ...
      if (response.data == null ||
        ...
        if (response.statusCode != 200) {
          ...
          final String msg = (data is Map && data['message'] != null)
              ...
              : (data is String ? data : 'Request failed');
          return Left(
              GetDataFailure(message: msg, statusCode: response.statusCode!));
        } else {
          if (mapType == 'google_map') {
            final data = response.data;
            if (data is Map && data.isNotEmpty && data['results'] is List) {
              final List results = data['results'];
              for (var i = 0; i < results.length; i++) {
                final comp = results[i]['address_components'];
                if (comp is List &&
                    comp.isNotEmpty &&
                    comp[0] is Map &&
                    (comp[0]['types'] is List) &&
                    comp[0]['types'][0] != 'plus_code') {
            ...
            if (data is Map && data['display_name'] != null) {
              geocodingLatLngModel = GeocodingLatLngModel.fromJson(
                  {'success': true, 'address': data['display_name']});
            } else {
              // Unexpected response shape; return empty address gracefully
              geocodingLatLngModel = GeocodingLatLngModel.fromJson(
                  {'success': true, 'address': ''});
            }
          }
