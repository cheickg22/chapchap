...
import 'package:restart_user/features/driverprofile/presentation/widgets/image_picker_dialog.dart';
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              if (driverBloc.neededDocuments
                                  .firstWhere(
                                      (e) => e.id == driverBloc.choosenDocument)
                                  .hasIdNumer)
                                Column(
                                  children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        driverBloc.add(
                                            ChooseDateEvent(context: context));
                                      },
                                      child: Container(
                                        color: AppColors.darkGrey
                                            .withAlpha((0.1 * 255).toInt()),
