                    ...
                    children: [
                      if (arg.historyData.requestBill.data.basePrice != 0)
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.basePrice.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data.distancePrice != 0)
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.distancePrice.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data.timePrice != 0)
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.timePrice.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data.waitingCharge != 0)
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.waitingCharge.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data.adminCommision != 0)
                        FareBreakup(
                            showBorder: false,
                            text: AppLocalizations.of(context)!.convFee,
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.adminCommision.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data.promoDiscount != 0)
                        FareBreakup(
                          showBorder: false,
                          text: AppLocalizations.of(context)!.discount,
                          price:
                              '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.promoDiscount.toStringAsFixed(2)}',
                      ...
                      if (arg.historyData.requestBill.data
                        ...
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.additionalChargesAmount.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill != null &&
                        ...
                        FareBreakup(
                            ...
                            price:
                                '-${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.cancellationFee.toStringAsFixed(2)}'),
                      ...
                      FareBreakup(
                          ...
                          price:
                              '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.serviceTax.toStringAsFixed(2)}'),
                      if (arg.historyData.requestBill.data
                        ...
                        FareBreakup(
                            ...
                            price:
                                '${arg.historyData.requestBill.data.requestedCurrencySymbol} ${arg.historyData.requestBill.data.preferencePriceTotal.toStringAsFixed(2)}'),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
