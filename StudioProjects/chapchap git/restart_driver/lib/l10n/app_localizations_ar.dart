...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get agreeTermsAndPrivacy => 'من خلال الاستمرار فإنك توافق على البنود 1111 و2222';
  ...
  @override
  String get otpSentMobile => 'تم إرسال كلمة مرور لمرة واحدة (OTP) إلى هذا الرقم';
  ...
  @override
  String get continueWithoutPlanDesc => 'الاستمرار بدون خطة سيؤدي إلى دفع عمولة إدارية لكل رحلة';
  ...
  @override
  String get enterRideOtpDesc => 'أدخل رمز OTP الموضح في تطبيق العميل لبدء الرحلة';
  ...
  @override
  String get complaintLengthError => 'يجب أن تتكون الشكوى من 10 أحرف على الأقل.';
  ...
  @override
  String get lowWalletBalanceForSubscription => 'لا يوجد في محفظتك رصيد كافي لدفع هذا الاشتراك، يرجى تجربة طريقة أخرى أو إضافة أموال إلى المحفظة';
  ...
  @override
  String get userCancelledDesc => 'ألغى المستخدم الرحلة. أنت الآن متاح لطلبات أخرى.';

  @override
  String get userDeclinedBid => 'رفض المستخدم العرض';

  @override
  String get userDeclinedBidDesc => 'يرجى تعديل المبلغ الخاص بك والمحاولة مرة أخرى أو تجربة رحلة أخرى';
  ...
  @override
  String get deleteText => 'سيؤدي حذف حسابك إلى حذف جميع بياناتك الشخصية. هل ترغب بالمتابعة؟';

  @override
  String get welcomeToName => 'مرحباً بكم في 1111';

  @override
  String get locationPermDesc => 'يستخدم تطبيق 111 موقعك في الخلفية لتتبع رحلاتك وتحسين تجربة العميل، حتى عند إغلاق التطبيق. يتيح ذلك للعملاء تحديد موقعك بدقة وتحسين تجربة رحلاتك.';
  ...
  @override
  String get subscriptionFailedDescThree => 'قم بالتجديد الآن لمواصلة استخدام خدماتنا.';

  @override
  String get referalShareOne => 'انضم إليّ على ١١١! باستخدام رمز الدعوة ٢٢٢ لتسهيل رحلتك.';
  ...
  @override
  String get waitingForApprovelText => 'مستنداتك قيد المراجعة. سيتم منح الموافقة خلال 24 ساعة. يرجى الانتظار لبدء أرباحك.!';
  ...
  @override
  String get offlineConfirmation => 'هل أنت متأكد أنك تريد البقاء غير متصل بالإنترنت؟';
  ...
  @override
  String get levelupSuccessText => 'لقد أكملت 25 رحلة، لذا فقد حصلت على المستوى 1، تهانينا على حصولك على هذا المستوى';
  ...
  @override
  String get howItWorksPointThree => 'تحويل النقاط إلى أموال عند الوصول إلى مبلغ معين.';

  @override
  String get howItWorksPointFour => 'استبدل النقاط المحولة للحصول على خصومات أو استرداد نقدي.';
  ...
  @override
  String get locationAccess => 'يلزم الوصول إلى الموقع لتشغيل التطبيق، يرجى تمكينه في الإعدادات والنقر فوق تم';
  ...
  @override
  String get noSubscriptionContent => 'احصل على المزايا المميزة من خلال اختيار خطة اشتراك مصممة خصيصًا لتلبية احتياجاتك.';
  ...
  @override
  String get outStatonSuccessText => 'قبل أحد المستخدمين عرضك. تفقّده في قسم \"القادم\".';

  @override
  String get readyToPickup => 'جاهز للاستلام';

  @override
  String get outStationSuccess => 'بمجرد قبول عرضك من قبل المستخدم، سيتم إعلامك في القسم القادم';
  ...
  @override
  String get locationBackgroundServiceNotificationTitle => 'سيستمر 1111 في تلقي موقعك في الخلفية';
  ...
  @override
  String get getYourCurrentLocation => 'السماح بإذن الموقع للحصول على موقعك الحالي';
  ...
  @override
  String get demoOtpText => 'قم بتسجيل الدخول إلى حسابك باستخدام رمز OTP التجريبي 123456';
  ...
  @override
  String get maximumRideFareError => 'يجب أن تكون أجرة الرحلة المعروضة أقل من الحد الأقصى للأجرة.';

  @override
  String get minimumRideFareError => 'يجب أن تكون أجرة الرحلة المعروضة أكبر من الحد الأدنى للأجرة.';

  @override
  String get overlayPermission => 'يرجى السماح لـ Overlay Permission بالظهور على التطبيقات الأخرى';
  ...
  @override
  String get dignosticsSolutionText => 'سنعمل على تحديد المشكلات الخاصة بالجهاز وتقديم حلول مخصصة لحلها.';
  ...
  @override
  String get locationSubText => 'سوف نقوم بالتحقق من نظام تحديد المواقع العالمي (GPS) الخاص بك لضمان تتبع موقعك بدقة.';
  ...
  @override
  String get alertNotificationSubText => 'إذا تلقيت الرمز *، فانقر على زر \"نعم\".';
  ...
  @override
  String get waitingChargeText => 'يتم تطبيق رسوم إضافية على الدقيقة* في حالة وقت الانتظار الإضافي.';
  ...
  @override
  String get selectCardText => 'يمكنك اختيار أرقام البطاقات التي تريد عرضها في قائمة طرق الدفع الموجودة على الفاتورة.';
  ...
  @override
  String get rideEndConfirmationText => 'هل أنت متأكد من أنك تريد إنهاء الرحلة؟';
