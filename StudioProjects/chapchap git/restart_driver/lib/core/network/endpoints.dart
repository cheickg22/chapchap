...
//support ticket
  ...
  //moov money
  static String getMoovMoneyRequest = 'api/v1/driver/moov-money/request/';
  static String processMoovMoneyDeposit = 'api/v1/driver/moov-money/process-deposit';
  static String processMoovMoneyWithdrawal = 'api/v1/driver/moov-money/process-withdrawal';
  static String cancelMoovMoneyRequest = 'api/v1/driver/moov-money/cancel';
  static String moovMoneyHistory = 'api/v1/driver/moov-money/history';
  static String moovMoneyEarnings = 'api/v1/driver/moov-money/earnings';
