...
class MetaData {
  ...
  // Champs Moov Money
  bool? isMoovMoney;
  String? moovMoneyType;
  String? moovMoneyAmount;
  String? moovMoneyPhone;
  String? moovMoneyVoucherCode;
  String? moovMoneySecurityCode;
  String? moovMoneyStatus;
  MetaData(
      {required this.id,
      ...
      this.isMoovMoney,
      this.moovMoneyType,
      this.moovMoneyAmount,
      this.moovMoneyPhone,
      this.moovMoneyVoucherCode,
      this.moovMoneySecurityCode,
      this.moovMoneyStatus});
  ...
  factory MetaData.fromJson(Map<String, dynamic> json) => MetaData(
        ...
        pickLat: json["pick_lat"] is int ? (json["pick_lat"] as int).toDouble() : json["pick_lat"],
        pickLng: json["pick_lng"] is int ? (json["pick_lng"] as int).toDouble() : json["pick_lng"],
        dropLat: json["drop_lat"] is int ? (json["drop_lat"] as int).toDouble() : json["drop_lat"],
        dropLng: json["drop_lng"] is int ? (json["drop_lng"] as int).toDouble() : json["drop_lng"],
        ...
        isPreferenceList: (json["requestPreferences"] != null)
              ...
              : null,
        isMoovMoney: json["is_moov_money"],
        moovMoneyType: json["moov_money_type"],
        moovMoneyAmount: json["moov_money_amount"]?.toString(),
        moovMoneyPhone: json["moov_money_phone"],
        moovMoneyVoucherCode: json["moov_money_voucher_code"],
        moovMoneySecurityCode: json["moov_money_security_code"],
        moovMoneyStatus: json["moov_money_status"],
      );
}
...
class RequestPreferencesList {
    ...
    factory RequestPreferencesList.fromJson(Map<String, dynamic> json) => RequestPreferencesList(
        data: List<RequestPreferencesListData>.from(json["data"].map((x) => RequestPreferencesListData.fromJson(x))),
    );
}
...
class RequestPreferencesListData {
    ...
    factory RequestPreferencesListData.fromJson(Map<String, dynamic> json) => RequestPreferencesListData(
        id: json["id"],
...
class RequestPreferences {
    ...
    factory RequestPreferences.fromJson(Map<String, dynamic> json) => RequestPreferences(
        data: List<RequestPreferencesData>.from(json["data"].map((x) => RequestPreferencesData.fromJson(x))),
    );
}
...
class RequestPreferencesData {
    ...
    factory RequestPreferencesData.fromJson(Map<String, dynamic> json) => RequestPreferencesData(
        id: json["id"],
        preferencePriceId: json["preference_price_id"],
        preferenceId: json["preference_id"],
        name: json["name"],
...
class RequestBill {
  ...
  factory RequestBill.fromJson(Map<String, dynamic> json) => RequestBill(
        ...
        requestedCurrencyCode: json["requested_currency_code"]?.toString() ?? '',
        currencySymbol: json["requested_currency_symbol"]?.toString() ?? '',
        adminCommisionWithTax: json["admin_commision_with_tax"]?.toDouble(),
        calculatedWaitingTime: int.tryParse(json["calculated_waiting_time"]?.toString() ?? '0') ?? 0,
        ...
        additionalChargesReason: json["additional_charges_reason"]?.toString() ?? '',
