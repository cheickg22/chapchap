...
import 'package:restart_user/features/home/domain/models/diagnostic_otification_model.dart';
import 'package:restart_user/features/home/domain/models/get_preferences_model.dart';
import 'package:restart_user/features/home/domain/models/online_offline_model.dart';
import 'package:restart_user/features/home/domain/models/price_per_distance_model.dart';
import 'package:restart_user/features/home/domain/models/update_preference_model.dart';
...
class HomeRepositoryImpl implements HomeRepository {
  ...
  // UserDetailData
  @override
  Future<Either<Failure, UserDetailResponseModel>> getUserDetails({String? requestId}) async {
    UserDetailResponseModel userDetailsResponseModel;
    try {
      Response response = await _homeApi.getUserDetailsApi(requestId: requestId);
  ...
  Future<Either<Failure, UpdatePreferencesModel>> updatePreferences(
    ...
    try {
      Response response =
          await _homeApi.updatePreferences(id: id);
      if (response.data == null || response.data == '') {
        return Left(GetDataFailure(message: 'User bad request'));
      } else if (response.data['error'] != null) {
        return Left(GetDataFailure(message: response.data['error']));
