          ...
          if (map != 'google_map') {
            ...
            if (mapType != 'google_map') {
              for (var i = 0; i < routes[0]["legs"].length; i++) {
                etaDistance =
                    etaDistance + (routes[0]["legs"][i]['distance']);
                etaDuration =
                    etaDuration + (routes[0]["legs"][i]['duration']);
              }
            }
            ...
            // Vérifier que routes existe et n'est pas vide
            if (response.data['routes'] != null && 
              ...
              // Routes vide ou null - retourner une polyline vide
              polylineModel = PolylineModel.fromJson({
                'success': true,
                'polyString': '',
                'distance': '0',
