...
import 'package:restart_user/common/pickup_icon.dart';
        ...
        builder: (context, state) {
          ...
          if (homeBloc.outStationList.isNotEmpty &&
              homeBloc.outStationList.firstWhere((e) =>
                      e['request_id'] ==
                      homeBloc.choosenRide)['trip_stops'] !=
                  'null') {
              ...
              SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: MyText(
                      text: homeBloc.outStationList.firstWhere(
                          (e) =>
                              e['request_id'] ==
                              context
                                  .read<HomeBloc>()
                ...
                child: Row(
                  ...
                  children: [
                      ...
                      onTap: () {
                        if (!context
                            ...
                            !context
                                .read<HomeBloc>()
                                .isBiddingDecreaseLimitReach) {
                          homeBloc.add(AcceptBidRideEvent(
                              id: homeBloc.choosenRide!));
                        } else {
                    ...
                    CustomButton(
                      ...
                      onTap: () {
                        homeBloc.add(DeclineBidRideEvent(
                            id: homeBloc.choosenRide!));
                      },
                      width: size.width * 0.41,
