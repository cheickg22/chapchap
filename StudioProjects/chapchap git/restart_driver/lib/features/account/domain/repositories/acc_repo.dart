...
abstract class AccRepository {
  ...
  Future<Either<Failure, dynamic>> makeComplaintButton(String complaintTitleId,
      String complaintText, String requestId);
  ...
  Future<Either<Failure, dynamic>> updateDetailsButton({required String email,
    required String name,
  ...
  Future<Either<Failure, DriverDataModel>> addDrivers({required String name,
  ...
  Future<Either<Failure, AddMyRouteAddressResponse>> addressUpdated(
      {required double myRouteLat, required double myRouteLng, required String myRouteAddress});
