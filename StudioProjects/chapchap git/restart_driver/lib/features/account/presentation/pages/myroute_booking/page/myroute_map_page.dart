                                  ...
                                  accBloc.debouncer
                                    ...
                                    if (v.length >= 4) {
                                      if (accBloc.currentLatLng != null) {
                                        ...
                                        accBloc.add(AccGetCurrentLocationEvent());
                                      }
                                    } else if (v.isEmpty) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () {
                            Navigator.pop(context,MyRouteModel(
                              selectedAddress: accBloc.selectedMyRouteAddress, 
                              lat: accBloc.selectedMyRouteLatLng!.latitude, 
                              lng: accBloc.selectedMyRouteLatLng!.longitude));
                          },
                        )
                      ],
                    ),
    ...
    return GoogleMap(
      ...
      onMapCreated: (GoogleMapController controller) {
        ...
        if (Theme.of(context).brightness == Brightness.dark) {
         ...
         accBloc.googleMapController!
            .animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: accBloc.currentLatLng!,zoom:15)));
