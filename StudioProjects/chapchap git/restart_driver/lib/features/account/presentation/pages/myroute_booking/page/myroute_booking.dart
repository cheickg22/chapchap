                  ...
                  child: Column(
                    children: <Widget>[
                            ...
                            (value) {
                              if (value != null) {
                                ...
                                accBloc.selectedMyRouteAddress =
                                    val.selectedAddress;
                                accBloc.add(MyRouteAddressUpdateEvent(myRouteLng: val.lng, myRouteLat: val.lat, myRouteAddress: val.selectedAddress));
                              }
                            },
                          );
                      ...
                      CustomButton(
                        ...
                        ? AppLocalizations.of(context)!.disableMyrouteBooking
                        : AppLocalizations.of(context)!.enableMyrouteBooking,
                        ...
                        onTap: () async {
                          if (accBloc.currentLatLng != null) {
                            accBloc.add(EnableMyRouteBookingEvent(
                              isEnable: (userData!.enableMyRouteBooking == '1') ? false : true,
                              currentLat:
                                  accBloc.currentLatLng!.latitude,
                              currentLng:
