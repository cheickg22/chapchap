...
class MyRouteAutoSearchPlacesWidget extends StatelessWidget {
  final BuildContext cont;

  const MyRouteAutoSearchPlacesWidget({super.key, required this.cont});
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: MyText(
                      text: (context.read<AccBloc>().autoSuggestionSearching)
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ListView.builder(
                        itemCount:
                            context.read<AccBloc>().autoCompleteAddress.length,
