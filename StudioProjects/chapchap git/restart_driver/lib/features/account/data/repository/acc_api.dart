...
//delete notification
  ...
  Future makeComplaintButton(String complaintTitleId, String complaintText,
...
//Incentive
  ...
  Future updateDetailsButton({required String email,
    required String name,
  ...
  Future getLeaderBoard(
    ...
    try {
      ...
      Response response = await DioProviderImpl().get(
        (type == 0)
            ? '${ApiEndpoints
            .leaderBoardEarnings}?current_lat=$lat&current_lng=$lng'
            : '${ApiEndpoints
            .leaderBoardTrips}?current_lat=$lat&current_lng=$lng',
        headers: {'Content-Type': 'application/json', 'Authorization': token},
      );
      return response;
    } catch (e) {
