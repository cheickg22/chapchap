...
import 'package:restart_user/features/account/domain/models/driver_points_model.dart';
...
import 'package:restart_user/features/account/domain/models/enable_routebooking_model.dart';
import 'package:restart_user/features/account/domain/models/faq_model.dart';
import 'package:restart_user/features/account/domain/models/incentive_model.dart';
import 'package:restart_user/features/account/domain/models/leader_board_model.dart';
import 'package:restart_user/features/account/domain/models/make_ticket_model.dart';
...
import 'package:restart_user/features/account/domain/models/bank_details_model.dart';
import 'package:restart_user/features/account/domain/models/bank_details_update_model.dart';
...
import 'package:restart_user/features/account/domain/models/withdraw_request_model.dart';
...
//get drivers
  ...
  Future<Either<Failure, AddMyRouteAddressResponse>> addressUpdated({required double myRouteLat, required double myRouteLng, required String myRouteAddress})async{

    return _accRepository.addressUpdated(myRouteLat: myRouteLat, myRouteLng: myRouteLng, myRouteAddress: myRouteAddress);
  }
