...
class PaymentGatewayController  extends Controller
{
    ...
    // dd($settings);
        ...
        $formattedSettings = [
            ...
            'enable_orange_money' => filter_var($settings['enable_orange_money'] ?? false, FILTER_VALIDATE_BOOLEAN),
            'orange_money_environment' => $settings['orange_money_environment'] ?? '',
            'orange_money_client_id' => $settings['orange_money_client_id'] ?? '',
            'orange_money_client_secret' => $settings['orange_money_client_secret'] ?? '',
            'orange_money_merchant_key' => $settings['orange_money_merchant_key'] ?? '',
            
            // Orange Money Sandbox Credentials (Mali)
            'orange_money_sandbox_merchant_id' => $settings['orange_money_sandbox_merchant_id'] ?? '',
            'orange_money_sandbox_msisdn' => $settings['orange_money_sandbox_msisdn'] ?? '',
            'orange_money_sandbox_agent_code' => $settings['orange_money_sandbox_agent_code'] ?? '',
            'orange_money_sandbox_pin' => $settings['orange_money_sandbox_pin'] ?? '',
            'orange_money_sandbox_login' => $settings['orange_money_sandbox_login'] ?? '',
            'orange_money_sandbox_password' => $settings['orange_money_sandbox_password'] ?? '',
        ];
    ...
    public function update(Request $request)
    {
        ...
        $settings = $request->validate([
            ...
            'enable_orange_money' => "required",
            'orange_money_environment' => "required",
            'orange_money_client_id' => "sometimes",
            'orange_money_client_secret' => "sometimes",
            'orange_money_merchant_key' => "sometimes",
            
            // Orange Money Sandbox Credentials (Mali)
            'orange_money_sandbox_merchant_id' => "sometimes",
            'orange_money_sandbox_msisdn' => "sometimes",
            'orange_money_sandbox_agent_code' => "sometimes",
            'orange_money_sandbox_pin' => "sometimes",
            'orange_money_sandbox_login' => "sometimes",
            'orange_money_sandbox_password' => "sometimes",
