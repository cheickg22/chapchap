...
// Log::info($request->all());
    ...
    */
    public function listPackages(Request $request){
       ...
       // Filter by service_type if provided (for Moov Money vs normal delivery)
        if($request->has('service_type') && $request->service_type) {
            $type = $type->where('service_type', $request->service_type);
        }
        // Si service_type n'est pas fourni, on retourne tous les packages (normal + moov_money)
        // L'utilisateur pourra choisir dans l'app mobile
