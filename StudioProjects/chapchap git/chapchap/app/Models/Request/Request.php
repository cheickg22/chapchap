...
class Request extends Model
{
    ...
    'is_moov_money','moov_money_type','moov_money_amount','moov_money_phone','moov_money_voucher_code',
    'moov_money_validation_code','moov_money_security_code','moov_money_transaction_id','moov_money_status','moov_money_processed_at',
    'is_driver_completed','trip_end_time',
    ];
   ...
   public function promo()
    ...
    /**
     * The Moov Money transaction associated with the request.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function moovMoneyTransaction()
    {
        return $this->belongsTo(MoovMoneyTransaction::class, 'moov_money_transaction_id', 'id');
    }
