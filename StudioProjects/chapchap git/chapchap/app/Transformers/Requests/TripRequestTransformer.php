...
class TripRequestTransformer extends Transformer
{
    ...
    public function transform(RequestModel $request)
    {
        ...
        $params =  [
            ...
            'pick_address'=>$request->pick_address ?? $request->requestPlace->pick_address ?? '',
            'drop_address'=>$request->drop_address ?? $request->requestPlace->drop_address ?? '',
            ...
            // Moov Money fields
            'is_moov_money' => (int)$request->is_moov_money === 1 ? true : false,
            'moov_money_type' => $request->moov_money_type ?? null,
            'moov_money_amount' => $request->moov_money_amount ? (float)$request->moov_money_amount : null,
            'moov_money_phone' => $request->moov_money_phone ?? null,
            'moov_money_voucher_code' => $request->moov_money_voucher_code ?? null,
            'moov_money_validation_code' => $request->moov_money_validation_code ?? null,
            'moov_money_security_code' => $request->moov_money_security_code ?? null,
            'moov_money_status' => $request->moov_money_status ?? null,
            'moov_money_processed_at' => $request->moov_money_processed_at ?? null,
