...
//outstation rides
     ...
     */
        ...
        // Moov Money Requests
        Route::post('moov-money/deposit/create', 'MoovMoneyRequestController@createDepositRequest');
        Route::post('moov-money/withdrawal/create', 'MoovMoneyRequestController@createWithdrawalRequest');
        // Note: Use /api/v1/moov-money/my-requests instead (defined in moov_money.php)
     ...
     */
        ...
        Route::middleware(['auth:sanctum','throttle:120,1'])->post('payment-confirm', 'DriverEndRequestController@paymentConfirm');
