...
Route::group(['prefix' => 'driver-import', 'middleware' => 'permission:user-import'], function () {
    Route::get('/', [DriverImportController::class, 'index'])->name('userImport.index');
    Route::middleware(['permission:add_banner_image'])->get('/create', [DriverImportController::class, 'create'])->name('userImport.create');
    Route::get('/list', [DriverImportController::class, 'list'])->name('userImport.list');
    Route::post('/import-file', [DriverImportController::class, 'import'])->name('userImport.import');
    Route::get('/download-invalid-file/{id}', [DriverImportController::class, 'downloadInvalidFile'])->name('userImport.downloadInvalidFile');
    Route::get('/reupload-invalid-file/{id}', [DriverImportController::class, 'reuploadInvalidFile'])->name('userImport.reuploadInvalidFile');
    Route::post('/reupload-invalid-file-store/{driverImport}', [DriverImportController::class, 'reuploadInvalidFileStore'])->name('userImport.reuploadInvalidFileStore');


    Route::get('/sample-download', [DriverImportController::class, 'sampleDownload'])->name('userImport.sampleDownload');
