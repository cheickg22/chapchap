...
Route::group(['prefix' => 'moov-money', 'middleware' => 'permission:admin'], function () {
    Route::get('/', [App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'index'])->name('moov-money.index');
    Route::get('/dashboard', [App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'dashboard'])->name('moov-money.dashboard');
    Route::get('/export', [App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'export'])->name('moov-money.export');
    Route::get('/{id}', [App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'show'])->name('moov-money.show');
    Route::post('/{id}/cancel', [App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'cancel'])->name('moov-money.cancel');
});
...
Route::group(['prefix' => 'moov-money-transactions'], function () {
    Route::middleware(['permission:moov-money-transactions'])->get('/', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'index'])->name('moovMoney.index');
    Route::middleware('remove_empty_query')->get('/list', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'list'])->name('moovMoney.list');
    Route::get('/view/{requestmodel}', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'viewDetails'])->name('moovMoney.viewDetails');
    Route::get('/export', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'export'])->name('moovMoney.export');
    Route::post('/cancel/{id}', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'cancel'])->name('moovMoney.cancel');
    Route::delete('/delete/{id}', [\App\Http\Controllers\Web\Admin\MoovMoneyTransactionController::class, 'delete'])->name('moovMoney.delete');
});
...
//easypaisa
    ...
    // Orange Money WebPay
    Route::get('payment/orange-money', [\App\Http\Controllers\Web\OrangeMoneyController::class, 'index'])->name('orange_money');
    Route::post('payment/orange', [\App\Http\Controllers\Web\OrangeMoneyController::class, 'payment'])->name('orange.payment');
    Route::get('payment/orange-money/success', [\App\Http\Controllers\Web\OrangeMoneyController::class, 'paymentSuccess'])->name('orange.success');
    Route::get('payment/orange-money/cancel', [\App\Http\Controllers\Web\OrangeMoneyController::class, 'paymentCancel'])->name('orange.cancel');
...
Route::group(['prefix' => 'dispatcher-addons', 'middleware' => 'permission:dispatcher_addons'], function () {
    ...
    // Installation verification route
    Route::post('/verfication-submit', [InstallationController::class, 'verification_submit'])->name('verfication-submit');
    ...
    // Route de test pour visualiser les transactions Moov Money
    Route::get('/moov-money-test', [App\Http\Controllers\MoovMoneyTestController::class, 'index'])->name('moov-money.test');
