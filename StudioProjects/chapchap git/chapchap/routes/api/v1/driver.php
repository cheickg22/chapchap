...
Route::prefix('driver')->namespace('Driver')->middleware(['auth:sanctum','throttle:120,1'])->group(function () {
        ...
        Route::prefix('moov-money')->group(function () {
            // Actions sur les requêtes (namespace absolu: Request\Driver)
            Route::namespace('\App\Http\Controllers\Api\V1\Request\Driver')->group(function () {
            ...
            // Historique et gains (namespace: Driver - relatif)
        ...
        // Route générique pour le polling de statut (service hybride)
        // Supporte tous les types: taxi, delivery, moov_money, dispatcher
        Route::get('request/{id}/status', '\App\Http\Controllers\Api\V1\Request\RequestStatusController@getStatusDriver');    
        ...
        // Routes Moov Money pour les drivers
