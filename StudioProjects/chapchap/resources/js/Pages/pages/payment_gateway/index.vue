...
export default {
    ...
    const form = useForm({
        ...
        enable_orange_money: props.settings.enable_orange_money ?? false,
        orange_money_environment: props.settings.orange_money_environment ?? '',
        orange_money_client_id: props.settings.orange_money_client_id ?? '',
        orange_money_client_secret: props.settings.orange_money_client_secret ?? '',
        orange_money_merchant_key: props.settings.orange_money_merchant_key ?? '',
        
        // Orange Money Sandbox Credentials (Mali)
        orange_money_sandbox_merchant_id: props.settings.orange_money_sandbox_merchant_id ?? '',
        orange_money_sandbox_msisdn: props.settings.orange_money_sandbox_msisdn ?? '',
        orange_money_sandbox_agent_code: props.settings.orange_money_sandbox_agent_code ?? '',
        orange_money_sandbox_pin: props.settings.orange_money_sandbox_pin ?? '',
        orange_money_sandbox_login: props.settings.orange_money_sandbox_login ?? '',
        orange_money_sandbox_password: props.settings.orange_money_sandbox_password ?? '',
                            ...
                            <BCol lg="6">
                                <BCard no-body id="tasksList" class="border" >
                                    <BCardHeader class="border-0">
                                        <div class="row border-bottom p-2">
                                            <div class="col-6 ">
                                                <h5 class="mt-1">{{$t("orange_money")}}</h5>                                                           
                                            </div>
                                            <div class="col-6">
                                                <div class="form-check form-switch form-switch-lg float-end me-3">
                                                    <input v-model="form.enable_orange_money" class="form-check-input" type="checkbox" role="switch" id="enable_orange_money" @change="handleCheckboxChange('enable_orange_money')" />
                                                </div>                                                              
                                            </div>
                                        </div>
                                    </BCardHeader>
                                    <BCardBody >
                                        <div  class="text-center mb-4">
                                            <img src="@assets/images/orange-money.png"  style="width: 200px;" >
                                        </div> 
                                        <div class="mb-3">
                                            <label for="orange_money_environment" class="form-label">{{$t("orange_money_environment")}}</label>
                                            <select :disabled="app_for === 'demo'" id="orange_money_environment" class="form-select" v-model="form.orange_money_environment">
                                                <option disabled value="">{{$t("select")}}</option>
                                                <option value="sandbox">Sandbox (Mali)</option>
                                                <option value="dev">{{$t("test")}}</option>
                                                <option value="prod">{{$t("production")}}</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label for="orange_money_client_id" class="form-label">{{$t("orange_money_client_id")}}</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" :placeholder="$t('enter_orange_money_client_id')" id="orange_money_client_id" v-model="form.orange_money_client_id" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="orange_money_client_secret" class="form-label">{{$t("orange_money_client_secret")}}</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" :placeholder="$t('enter_orange_money_client_secret')" id="orange_money_client_secret" v-model="form.orange_money_client_secret" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="orange_money_merchant_key" class="form-label">{{$t("orange_money_merchant_key")}}</label>
                                            <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" :placeholder="$t('enter_orange_money_merchant_key')" id="orange_money_merchant_key" v-model="form.orange_money_merchant_key" />
                                        </div>
                                        
                                        <!-- Sandbox Credentials (Mali) -->
                                        <div v-if="form.orange_money_environment === 'sandbox' || form.orange_money_environment === ''" class="border-top pt-3 mt-3">
                                            <h6 class="mb-3 text-primary">Sandbox Credentials (Mali) <span class="badge bg-info">Optional - Only for Sandbox</span></h6>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_merchant_id" class="form-label">Merchant ID</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="MerchantWP00230" id="orange_money_sandbox_merchant_id" v-model="form.orange_money_sandbox_merchant_id" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_msisdn" class="form-label">MSISDN</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="7701900230" id="orange_money_sandbox_msisdn" v-model="form.orange_money_sandbox_msisdn" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_agent_code" class="form-label">Agent Code</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="101350" id="orange_money_sandbox_agent_code" v-model="form.orange_money_sandbox_agent_code" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_pin" class="form-label">PIN</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="0163" id="orange_money_sandbox_pin" v-model="form.orange_money_sandbox_pin" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_login" class="form-label">Login (Client ID)</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="7701900230" id="orange_money_sandbox_login" v-model="form.orange_money_sandbox_login" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="orange_money_sandbox_password" class="form-label">Password (Client Secret)</label>
                                                <input :type="app_for === 'demo' ? 'password' : 'text'" :readonly="app_for === 'demo'" class="form-control" placeholder="MerchantWP00230" id="orange_money_sandbox_password" v-model="form.orange_money_sandbox_password" />
                                            </div>
                                        </div>
                                        
                                        <div class="alert bg-warning border-warning text-white" role="alert">
                                            <strong>Note:</strong> <b>Update the following Webhook URL in Orange Money Portal</b><br>
                                            <em><b class="fs-14">{{ $page.props.ziggy.url }}/api/v1/payment/orange-money/webhook</b></em>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="text-end">
                                            <button type="submit" class="btn btn-primary"> {{ $t('save') }}</button>
